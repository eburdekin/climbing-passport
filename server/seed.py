...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        mountain6 = Mountain(
            name="Bring Out Your Dead", location="Red River Gorge", type="Trad", grade="5.9"
        )
        mountain7 = Mountain(
            name="When Doves Cry", location="Red River Gorge", type="Bouldering", grade="V5"
        )
        mountain8 = Mountain(
            name="Banshee", location="Red River Gorge", type="Sport", grade="5.11c"
        )
        mountain9 = Mountain(
            name="Breakfast Burrito", location="Red River Gorge", type="Sport", grade="5.10c"
        )
        mountain10 = Mountain(
        ...
        mountain15 = Mountain(
            name="Burning Calves", location="New River Gorge", type="Trad", grade="5.10b"
        )
        mountain16 = Mountain(
            name="Thunderstruck", location="New River Gorge", type="Sport", grade="5.12b"
        )
        mountain17 = Mountain(
        ...
        mountain22 = Mountain(
            name="Saturday Night Live", location="Joshua Tree", type="Bouldering", grade="V4"
        )
        mountain23 = Mountain(
        ...
        mountain26 = Mountain(
            name="Streetcar Named Desire", location="Joshua Tree", type="Bouldering", grade="V6"
        )
        mountain27 = Mountain(
        ...
        mountain29 = Mountain(
            name="Dream of Wild Turkeys", location="Red Rocks", type="Trad", grade="5.10a"
        )
        mountain30 = Mountain(
            name="Cloud Tower", location="Red Rocks", type="Trad", grade="5.12a"
        )
        mountains = [mountain1, mountain2, mountain3, mountain4, mountain5, mountain6, mountain7, mountain8, mountain9, mountain10, mountain11, mountain12, mountain13, mountain14, mountain15, mountain16, mountain17, mountain18, mountain19, mountain20, mountain21, mountain22, mountain23, mountain24, mountain25, mountain26, mountain27, mountain28, mountain29, mountain30]

        print("Creating badges...")
        b1 = Badge(climber=climber1, mountain=mountain2, date=2023-10-31, completed="Yes")
        b2 = Badge(
            climber=climber1, mountain=mountain5, date=2023-05-27, completed="Attempted"
        )
        b3 = Badge(climber=climber1, mountain=mountain6, date=2022-09-15, completed="No")
        b4 = Badge(climber=climber1, mountain=mountain1, date=2024-01-10, completed="Yes")
        b5 = Badge(climber=climber1, mountain=mountain8, date=2023-07-31, completed="No")
        b6 = Badge(
            climber=climber1, mountain=mountain12, date=2022-09-15, completed="Attempted"
        )
        b7 = Badge(climber=climber2, mountain=mountain14, date=2023-10-31, completed="Yes")
        b8 = Badge(
            climber=climber2, mountain=mountain17, date=2023-05-27, completed="Attempted"
        )
        b9 = Badge(climber=climber2, mountain=mountain18, date=2022-09-15, completed="No")
        b10 = Badge(climber=climber2, mountain=mountain19, date=2024-01-10, completed="Yes")
        b11 = Badge(climber=climber2, mountain=mountain23, date=2023-07-31, completed="No")
